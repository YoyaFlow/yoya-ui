...
| [`benchmarks.md`](benchmarks.md)                                               | Core benchmark report: standard operations, startup, memory, component overhead, virtualized rows | Generated from `benchmarks/results` |
