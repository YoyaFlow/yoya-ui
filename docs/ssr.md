...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Reading `document` / `window` inside the view build / `toHTML()`                                                                              | Access the DOM only in event callbacks or `renderDom()`; guard browser APIs with `typeof xxx === 'undefined'`                                                                | There is no DOM on the server, so the render path must stay DOM-free                    |
