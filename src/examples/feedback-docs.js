...
toast.use(host);`,
    examples: [
      ...
      },
      {
        ...
        id: 'container',
        imports: ['ref', 'vMessageContainer', 'vText', 'vstack'],
      ...
      },
      {
        ...
        id: 'toast',
        imports: ['ref', 'toast', 'vText', 'vstack'],
