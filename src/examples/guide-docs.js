    ...
    sections: [
      {
        title: '是什么',
        paragraphs: [
          'yoya-ui 回归浏览器原生 DOM，消除虚拟 DOM、JSX/SFC 编译与框架运行时等因早期 Web 标准不足而发明的技术特性，采用声明式结构化 JS 元素构建方案，视图与操作逻辑同源，消除 HTML 标签化语言与复杂操作逻辑不兼容的问题；同时提供组件、布局、状态、路由、i18n 与图表适配，并直接支持 AI 生成组件。'
        ]
      },
      {
        title: '版本演进友好',
