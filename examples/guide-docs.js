    ...
    sections: [
      {
        ...
        points: [
          ...
          '原生生态继承：基于浏览器原生标准的真实 DOM 操作，所有支持原生 Web 的组件与工具库都能通过扩展点直接继承接入；绝大多数 JS 库都以 DOM 为接口，无需担心生态问题。',
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@yoyaflow/yoya-ui@0.7.3/dist/yoya.ui.css" />
<script type="module">
  import { div, svg, ref, vText } from
    'https://cdn.jsdelivr.net/npm/@yoyaflow/yoya-ui@0.7.3/dist/yoya.core.min.js';
