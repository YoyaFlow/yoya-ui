...
declare module '@yoyaflow/yoya-core/html' {
  interface HtmlElementNode extends AsyncParentShortcuts {}
}
  ...
  interface ElementNode {
    ...
    vDynamicLoader(
      first?:
        | DynamicLoaderOptions
        | (() => unknown)
        | import('@yoyaflow/yoya-core').SetupCallback<DynamicLoaderNode>,
      options?: import('@yoyaflow/yoya-core').ElementOptions,
      callback?: import('@yoyaflow/yoya-core').SetupCallback<DynamicLoaderNode>
    ): DynamicLoaderNode;
  }
}
