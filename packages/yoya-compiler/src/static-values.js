 ...
 * 契约助手自己的模块 `…/core/component-authoring.js`、以及公开的 `@yoyaflow/yoya-core`。
 */
const STATIC_MODULE_PATTERN =
  /((^|\/)components\/shared(\.js)?$)|((^|\/)core\/component-authoring(\.js)?$)|(^@yoyaflow\/yoya-core$)/;
