...
// `String.prototype.s()` 的返回类型来自工具子系统（i18n 已从核心入口拆到 `/tools`）
import type { I18n, I18nTextNode } from './tools.js';
...
export class ElementNode extends ViewNode {
  ...
  // 组件域的父快捷方法由组件包用 `declare module @yoyaflow/yoya-core` 增强进来：
  // vDynamicLoader（async）/ codeBlock（data-display）/ vThemeModeSwitch（theme）/
  // vRouter · vLink · vRouterView · vRouterViews（router）。
}
